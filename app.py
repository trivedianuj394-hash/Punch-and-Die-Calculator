...
# ============================================================
# THEME — custom colours + fonts (also set in .streamlit/config.toml)
# ============================================================
NAVY = "#1f4e79"
STEEL = "#2e6da4"
LIGHT = "#eef3f8"
...
.hero p {{ margin: 4px 0 0 0; opacity: 0.9; font-size: 0.95rem; }}
...
div[data-testid="stMetricValue"] {{ color: {NAVY}; font-family: 'Roboto Mono', monospace; }}
